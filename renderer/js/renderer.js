//Script OS and path import thanks to preload.js throught parameters in main.js
...
function loadImage(e){
    ...
    if (!isFileImage(file)){
        console.log('Please take an image')
        alertError('Please select a valid image')
        return

    }
    //Get original dimencsions
...
//Catch the image:done event from main.js
